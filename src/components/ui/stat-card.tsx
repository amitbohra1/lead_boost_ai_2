...
export function StatCard({ title, value, subtitle, icon: Icon, trend, colorScheme = "primary" }: StatCardProps) {
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-xl border bg-gradient-to-br p-6 transition-all hover:shadow-lg",
    ...
    >
      <div className="flex items-start justify-between">
        ...
        {Icon && (
          <div className={cn("rounded-lg p-3", colorClasses[colorScheme])}>
